            ...
            <div className={styles.wrapper}>
              ...
              <article className={styles.article}>
                <div>
                    ...
                    <p className={styles.description}>AWS로 웹서비스를 처음으로 배포</p>
                    <p className={styles.description}>Github Actions로 CD(Continuous Deployment) 사용</p>
                    <p className={styles.description}>Docker로 클라이언트와 서버를 하나의 컨테이너로 묶어 배포</p>
                    <p className={styles.description}>첫 Next.js 클라이언트 개발</p>
                </div>
                <hr className='lighter' />
                <div>
