              ...
              <article>
                ...
                <ProjectPageSignificances significances={[
                  ...
                  },
                  {
                    ...
                    description: '기존에 사용하던 Vue 대신 Next.js로 클라이언트를 개발한 첫 프로젝트입니다. React가 Vue보다 생태계가 더 크고 Function 기반 Hooks을 사용하기 더 적합하며 React를 사용하는 SPA를 구현하기에 Next.js가 가장 편리하기에 Next.js를 채택했습니다. 배포의 편리성을 위하여 SSR 대신 CSR을 사용한 점이 아쉬웠습니다.',
                  },
                ]}/>
